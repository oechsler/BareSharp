...
namespace BareKit.Lua.Interpreter
{
	...
	public class ScriptOptions
	{
		...
		/// <summary>
		/// Gets or sets a value indicating whether error messages will use Lua error locations instead of BareKit.Lua 
		...
		/// <summary>
		/// Gets or sets the stack depth threshold at which BareKit.Lua starts doing
		...
		/// in all other, more common scenarios. BareKit.Lua choice is to start performing
		...
		/// calls BareKit.Lua execution concurrently. However 1) the check is performed best effort (thus, it might
		...
		/// you are not calling BareKit.Lua execution concurrently as it is not supported.
		/// </summary>
